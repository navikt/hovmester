...
| **R1 Liten lavrisiko** | 1-3 filer, klart scope, ingen røde signaler, enkel lokal endring | Hopp over Souschef. Send direkte til **Juniorkokk**, **Kokk** eller **Konditor**. Inspeksjon er opt-in, eller spør gjesten ved tvil: "Ønsker du kryssmodell-review her?" Bekreft tilnærming hvis ikke triviell. |
